...
\subsection{Analysis of high dimensional single cell data for tumor heterogeneity}
...
\footnote{\emph{This work is done in collaboration with Saray Shai, Dane Taylor and Peter Mucha and appears in the following publications:}
  \begin{itemize}
 \item \emph{Clustering Network Layers with the Strata Multilayer Stochastic Block Model}. {\bf N. Stanley, S. Shai, D. Taylor, P.J. Mucha}. IEEE Transactions on Network Science and Engineering. 2016. \url{http://ieeexplore.ieee.org/abstract/document/7442167/}
\item \emph{Enhanced Detectability of Community Structure in Multilayer Networks Through Layer Aggregation}. {\bf D. Taylor, S. Shai, N. Stanley, P.J. Mucha}. Physical Review Letters. 2016. \url{https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.116.228301}
        \end{itemize}
...
%\footnote{
%  \emph{This work is done in collaboration with Saray Shai, Dane Taylor and Peter Mucha and appears in the following publications:}
%  \begin{itemize}
% \item \emph{Clustering Network Layers with the Strata Multilayer Stochastic Block Model}. {\bf N. Stanley, S. Shai, D. Taylor, P.J. Mucha}. IEEE Transactions on Network Science and Engineering. 2016. \url{http://ieeexplore.ieee.org/abstract/document/7442167/}
%\item \emph{Enhanced Detectability of Community Structure in Multilayer Networks Through Layer Aggregation}. {\bf D. Taylor, S. Shai, N. Stanley, P.J. Mucha}. Physical Review Letters. 2016. \url{https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.116.228301}
%        \end{itemize}
...
\subsection{Comparing network layers based on community structure}
...
\subsection{Related work in community detection of multilayer networks}
...
\subsection{A Summary of Novel Contributions of sMLSBM}
\indent 
...
\begin{figure}
\begin{center}
\includegraphics[width=.7\linewidth]{Figure3.pdf}
...
\includegraphics[width=.7\linewidth]{Figure4.pdf}
...
\subsection{Human Microbiome Project Example}
...
\subsubsection{Comparison of sMLSBM to multilayer network reducibility}
...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=.6\linewidth]{Fig5.pdf}
...
\noindent\fbox{%
    \parbox{\textwidth}{%
        \emph{This work is lead by Dane Taylor and in collaboration between myself, Saray Shai, and Peter Mucha.}
        }%
}
...
\subsection{Introduction to detectability}
...
\begin{figure}
\begin{center}
\includegraphics[width=.8\linewidth]{Detect}
...
\chapter[Network compression for community detection with super nodes]{Network compression for community detection with super nodes \footnote{
       \emph{This work is done in collaboration with Roland Kwitt, Marc Niethammer, and Peter Mucha and appears in the following publication:}
...
\section{Representing images with super pixels before segmentation}
...
\subsubsection{An opportunity for super nodes in community detection}
...
\centering
%\begin{center}
\includegraphics[scale=0.5]{Schematic_smaller.pdf}
...
%\begin{center}
%\centering
\includegraphics[width=0.5\textwidth]{Synthetic}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.5]{Conceptual}
...
\centering
%\begin{center}
\includegraphics[width=0.7\textwidth]{RunTime}
...
\begin{center}
\centering
\includegraphics[width=0.7\textwidth]{VariabilityFigBoth.pdf}
...
\subsubsection{Adjacency Matrix Likelihood}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.6]{DetectExp.pdf}
...
\subsection{Results in biological networks}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.7]{MicrobiomeNets_Dec12.pdf}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.7]{CollabFilterMicro.pdf}
...
\subsubsection{Protein Interaction Network Results}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.7]{CollabProtein.pdf}
...
Finally, recent work by Perozzi \emph{et al.} defines a modularity-inspired quantity known as \emph{community normality} \cite{perozziAttribute}. This measure prioritizes partitions where members of a community are very similar to each other in attribute space (and obviously in connectivity patterns). Further, members of a community are also expected to be different from nodes on the community boundary or in a different community. 
...
\centering
\begin{center}
\includegraphics[scale=0.6]{Schem.pdf}
...
After computing ${\bf Y}^{U}$ and ${\bf Y}^{U,\text{perm}}$, the next step is to compute their corresponding entropies, $E$ and $E^{\text{perm}}$. We compute entropy $H(x)$ as,
...
When performing our label propagation task, we used a sample of 100 nodes and repeated the experiment for $T=1000$ trials. \\
...
\centering
\begin{center}
\includegraphics[width=0.7\textwidth]{MakerDist.pdf}
...
\noindent\fbox{%
    \parbox{\textwidth}{%
        \emph{This work is in collaboration with Dana Walsh.}
    }%
}
...
\section{Stochastic Block Models with Multiple Continuous Attributes}
\subsection{Recap}
...
\section{Testing Alignment of Attributes and Connectivity}
