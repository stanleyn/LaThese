...
\begin{center}
\centering
\includegraphics[scale=0.7]{VariabilityFigBoth.pdf}
...
\noindent\fbox{%
    \parbox{\textwidth}{%
        \emph{This work is done in collaboration with Thomas Bonacci, Roland Kwitt, Marc Niethammer, and Peter Mucha.}
    }%
}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.7]{ProteinNet_Dec12.pdf}
...
\centering
\begin{center}
\includegraphics[scale=0.5]{MakerDist.pdf}
