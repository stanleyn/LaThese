...
\indent An initially overwhelming network structure can be mediated by tools to break down,quantify, and describe structural patterns. In this section, we will describe several summary statistics and analyses that can be performed and will be seen throughout the rest of this thesis.\\
...
\caption{{\bf Effects of layer aggregation on detectability.} Add stuff.}
\label{Detect}
\end{center}
\end{figure}
