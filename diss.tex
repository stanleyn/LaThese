...
\noindent\fbox{%
    \parbox{\textwidth}{%
        \emph{This work is done in collaboration with Saray Shai, Dane Taylor and Peter Mucha.}
    }%
}
...
\noindent\fbox{%
    \parbox{\textwidth}{%
        \emph{This work is done in collaboration with Roland Kwitt, Marc Niethammer, and Peter Mucha.}
    }%
}
...
After computing ${\bf Y}^{U}$ and ${\bf Y}^{U,\text{perm}}$, the next step is to compute their corresponding entropies, $E$ and $E_{\text{perm}}$. We compute entropy $H(x)$ as,
